...
var file_protocol_proto_depIdxs = []int32{
	...
	69, // 36: communication.CombinedState.timestamp:type_name -> google.protobuf.Timestamp
	...
	56, // 47: communication.OSPFRouterData.router_states:type_name -> communication.OSPFRouterData.RouterStatesEntry
	57, // 48: communication.OSPFRouterArea.lsa_entries:type_name -> communication.OSPFRouterArea.LsaEntriesEntry
	58, // 49: communication.OSPFRouterLSA.router_links:type_name -> communication.OSPFRouterLSA.RouterLinksEntry
	59, // 50: communication.OSPFNetworkData.net_states:type_name -> communication.OSPFNetworkData.NetStatesEntry
	60, // 51: communication.NetAreaState.lsa_entries:type_name -> communication.NetAreaState.LsaEntriesEntry
	61, // 52: communication.NetworkLSA.attached_routers:type_name -> communication.NetworkLSA.AttachedRoutersEntry
	62, // 53: communication.OSPFSummaryData.net_states:type_name -> communication.OSPFSummaryData.NetStatesEntry
	63, // 54: communication.OSPFSummaryData.summary_states:type_name -> communication.OSPFSummaryData.SummaryStatesEntry
	64, // 55: communication.SummaryAreaState.lsa_entries:type_name -> communication.SummaryAreaState.LsaEntriesEntry
	...
	69, // 64: communication.AnomalyOveradvertisedRoute.timestamp:type_name -> google.protobuf.Timestamp
	46, // 65: communication.AnomalyOveradvertisedRoute.router:type_name -> communication.RouterAttribute
	69, // 66: communication.AnomalyUnderadvertisedRoute.timestamp:type_name -> google.protobuf.Timestamp
	46, // 67: communication.AnomalyUnderadvertisedRoute.router:type_name -> communication.RouterAttribute
	69, // 68: communication.AnomalyDuplicateRoute.timestamp:type_name -> google.protobuf.Timestamp
	46, // 69: communication.AnomalyDuplicateRoute.router:type_name -> communication.RouterAttribute
	69, // 70: communication.AnomalyMisconfiguredRoute.timestamp:type_name -> google.protobuf.Timestamp
	46, // 71: communication.AnomalyMisconfiguredRoute.router:type_name -> communication.RouterAttribute
	3,  // 72: communication.Message.ParamsEntry.value:type_name -> communication.Value
	3,  // 73: communication.Command.ParamsEntry.value:type_name -> communication.Value
	3,  // 74: communication.Struct.FieldsEntry.value:type_name -> communication.Value
	12, // 75: communication.StaticFRRConfiguration.RouteMapEntry.value:type_name -> communication.RouteMap
	13, // 76: communication.StaticFRRConfiguration.AccessListEntry.value:type_name -> communication.AccessList
	28, // 77: communication.OSPFRouterData.RouterStatesEntry.value:type_name -> communication.OSPFRouterArea
	29, // 78: communication.OSPFRouterArea.LsaEntriesEntry.value:type_name -> communication.OSPFRouterLSA
	30, // 79: communication.OSPFRouterLSA.RouterLinksEntry.value:type_name -> communication.OSPFRouterLSALink
	32, // 80: communication.OSPFNetworkData.NetStatesEntry.value:type_name -> communication.NetAreaState
	33, // 81: communication.NetAreaState.LsaEntriesEntry.value:type_name -> communication.NetworkLSA
	34, // 82: communication.NetworkLSA.AttachedRoutersEntry.value:type_name -> communication.AttachedRouter
	32, // 83: communication.OSPFSummaryData.NetStatesEntry.value:type_name -> communication.NetAreaState
	36, // 84: communication.OSPFSummaryData.SummaryStatesEntry.value:type_name -> communication.SummaryAreaState
	37, // 85: communication.SummaryAreaState.LsaEntriesEntry.value:type_name -> communication.SummaryLSA
