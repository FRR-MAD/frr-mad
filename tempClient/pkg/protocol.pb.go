...
const file_protocol_proto_rawDesc = "" +
	...
	"\x04data\x18\x03 \x01(\v2\x1c.communication.ResponseValueR\x04data\"\xd3\f\n" +
	"\rResponseValue\x12#\n" +
...
var file_protocol_proto_depIdxs = []int32{
	...
	57, // 23: communication.Struct.fields:type_name -> communication.Struct.FieldsEntry
	3,  // 24: communication.ListValue.values:type_name -> communication.ResponseValue
	7,  // 25: communication.StaticFRRConfiguration.interfaces:type_name -> communication.Interface
	8,  // 26: communication.StaticFRRConfiguration.static_routes:type_name -> communication.StaticRoute
	9,  // 27: communication.StaticFRRConfiguration.ospf_config:type_name -> communication.OSPFConfig
	58, // 28: communication.StaticFRRConfiguration.route_map:type_name -> communication.StaticFRRConfiguration.RouteMapEntry
	59, // 29: communication.StaticFRRConfiguration.access_list:type_name -> communication.StaticFRRConfiguration.AccessListEntry
	...
	14, // 34: communication.AccessList.access_list_items:type_name -> communication.AccessListItem
	15, // 35: communication.AccessListItem.ip_prefix:type_name -> communication.IPPrefix
	76, // 36: communication.CombinedState.timestamp:type_name -> google.protobuf.Timestamp
	17, // 37: communication.CombinedState.ospf:type_name -> communication.OSPFMetrics
	22, // 38: communication.CombinedState.config:type_name -> communication.NetworkConfig
	25, // 39: communication.CombinedState.system:type_name -> communication.SystemMetrics
	18, // 40: communication.OSPFMetrics.neighbors:type_name -> communication.OSPFNeighbor
	19, // 41: communication.OSPFMetrics.routes:type_name -> communication.OSPFRoute
	20, // 42: communication.OSPFMetrics.interfaces:type_name -> communication.OSPFInterface
	21, // 43: communication.OSPFMetrics.lsas:type_name -> communication.OSPFlsa
	23, // 44: communication.NetworkConfig.areas:type_name -> communication.OSPFArea
	24, // 45: communication.NetworkConfig.interfaces:type_name -> communication.OSPFInterfaceConfig
	26, // 46: communication.SystemMetrics.network_stats:type_name -> communication.InterfaceStats
	60, // 47: communication.OSPFRouterData.router_states:type_name -> communication.OSPFRouterData.RouterStatesEntry
	61, // 48: communication.OSPFRouterArea.lsa_entries:type_name -> communication.OSPFRouterArea.LsaEntriesEntry
	62, // 49: communication.OSPFRouterLSA.router_links:type_name -> communication.OSPFRouterLSA.RouterLinksEntry
	63, // 50: communication.OSPFNetworkData.net_states:type_name -> communication.OSPFNetworkData.NetStatesEntry
	64, // 51: communication.NetAreaState.lsa_entries:type_name -> communication.NetAreaState.LsaEntriesEntry
	65, // 52: communication.NetworkLSA.attached_routers:type_name -> communication.NetworkLSA.AttachedRoutersEntry
	66, // 53: communication.OSPFSummaryData.net_states:type_name -> communication.OSPFSummaryData.NetStatesEntry
	67, // 54: communication.OSPFSummaryData.summary_states:type_name -> communication.OSPFSummaryData.SummaryStatesEntry
	68, // 55: communication.SummaryAreaState.lsa_entries:type_name -> communication.SummaryAreaState.LsaEntriesEntry
	69, // 56: communication.OSPFAsbrSummaryData.asbr_summary_states:type_name -> communication.OSPFAsbrSummaryData.AsbrSummaryStatesEntry
	70, // 57: communication.OSPFExternalData.as_external_link_states:type_name -> communication.OSPFExternalData.AsExternalLinkStatesEntry
	71, // 58: communication.OSPFNssaExternalData.nssa_external_link_states:type_name -> communication.OSPFNssaExternalData.NssaExternalLinkStatesEntry
	72, // 59: communication.NssaExternalArea.data:type_name -> communication.NssaExternalArea.DataEntry
	...
	50, // 63: communication.Anomalies.misconfigured_routes:type_name -> communication.AnomalyMisconfiguredRoute
	76, // 64: communication.AnomalyOveradvertisedRoute.timestamp:type_name -> google.protobuf.Timestamp
	46, // 65: communication.AnomalyOveradvertisedRoute.router:type_name -> communication.RouterAttribute
	76, // 66: communication.AnomalyUnderadvertisedRoute.timestamp:type_name -> google.protobuf.Timestamp
	46, // 67: communication.AnomalyUnderadvertisedRoute.router:type_name -> communication.RouterAttribute
	76, // 68: communication.AnomalyDuplicateRoute.timestamp:type_name -> google.protobuf.Timestamp
	46, // 69: communication.AnomalyDuplicateRoute.router:type_name -> communication.RouterAttribute
	76, // 70: communication.AnomalyMisconfiguredRoute.timestamp:type_name -> google.protobuf.Timestamp
	46, // 71: communication.AnomalyMisconfiguredRoute.router:type_name -> communication.RouterAttribute
	73, // 72: communication.OspfRouterInfo.router_link_states:type_name -> communication.OspfRouterInfo.RouterLinkStatesEntry
	74, // 73: communication.AreaLinkStates.router_lsas:type_name -> communication.AreaLinkStates.RouterLsasEntry
	75, // 74: communication.RouterLSA.router_links:type_name -> communication.RouterLSA.RouterLinksEntry
	3,  // 75: communication.Message.ParamsEntry.value:type_name -> communication.ResponseValue
	3,  // 76: communication.Command.ParamsEntry.value:type_name -> communication.ResponseValue
	3,  // 77: communication.Struct.FieldsEntry.value:type_name -> communication.ResponseValue
	12, // 78: communication.StaticFRRConfiguration.RouteMapEntry.value:type_name -> communication.RouteMap
	13, // 79: communication.StaticFRRConfiguration.AccessListEntry.value:type_name -> communication.AccessList
	28, // 80: communication.OSPFRouterData.RouterStatesEntry.value:type_name -> communication.OSPFRouterArea
	29, // 81: communication.OSPFRouterArea.LsaEntriesEntry.value:type_name -> communication.OSPFRouterLSA
	30, // 82: communication.OSPFRouterLSA.RouterLinksEntry.value:type_name -> communication.OSPFRouterLSALink
	32, // 83: communication.OSPFNetworkData.NetStatesEntry.value:type_name -> communication.NetAreaState
	33, // 84: communication.NetAreaState.LsaEntriesEntry.value:type_name -> communication.NetworkLSA
	34, // 85: communication.NetworkLSA.AttachedRoutersEntry.value:type_name -> communication.AttachedRouter
	32, // 86: communication.OSPFSummaryData.NetStatesEntry.value:type_name -> communication.NetAreaState
	36, // 87: communication.OSPFSummaryData.SummaryStatesEntry.value:type_name -> communication.SummaryAreaState
	37, // 88: communication.SummaryAreaState.LsaEntriesEntry.value:type_name -> communication.SummaryLSA
	36, // 89: communication.OSPFAsbrSummaryData.AsbrSummaryStatesEntry.value:type_name -> communication.SummaryAreaState
	40, // 90: communication.OSPFExternalData.AsExternalLinkStatesEntry.value:type_name -> communication.ExternalLSA
	42, // 91: communication.OSPFNssaExternalData.NssaExternalLinkStatesEntry.value:type_name -> communication.NssaExternalArea
	43, // 92: communication.NssaExternalArea.DataEntry.value:type_name -> communication.NssaExternalLSA
	52, // 93: communication.OspfRouterInfo.RouterLinkStatesEntry.value:type_name -> communication.AreaLinkStates
	53, // 94: communication.AreaLinkStates.RouterLsasEntry.value:type_name -> communication.RouterLSA
	54, // 95: communication.RouterLSA.RouterLinksEntry.value:type_name -> communication.RouterLink
