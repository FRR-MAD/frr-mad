...
type ResponseValue struct {
	...
	//	*ResponseValue_DoubleValue
	//	*ResponseValue_BoolValue
	//	*ResponseValue_StructValue
	//	*ResponseValue_ListValue
	//	*ResponseValue_BytesValue
	//	*ResponseValue_CombinedState
	//	*ResponseValue_OspfMetrics
	//	*ResponseValue_OspfNeighbor
	//	*ResponseValue_OspfRoute
	//	*ResponseValue_OspfInterface
	//	*ResponseValue_OspfLsa
	//	*ResponseValue_NetworkConfig
	//	*ResponseValue_OspfArea
	//	*ResponseValue_OspfInterfaceConfig
	//	*ResponseValue_SystemMetrics
	//	*ResponseValue_InterfaceStats
...
func (x *ResponseValue) GetIntValue() int64 {
	if x != nil {
		if x, ok := x.Kind.(*ResponseValue_IntValue); ok {
			return x.IntValue
		}
	}
	return 0
...
func (x *ResponseValue) GetDoubleValue() float64 {
	if x != nil {
		if x, ok := x.Kind.(*ResponseValue_DoubleValue); ok {
...
func (x *ResponseValue) GetBoolValue() bool {
	if x != nil {
		if x, ok := x.Kind.(*ResponseValue_BoolValue); ok {
			return x.BoolValue
		}
	}
	return false
...
func (x *ResponseValue) GetStructValue() *Struct {
	if x != nil {
		if x, ok := x.Kind.(*ResponseValue_StructValue); ok {
...
func (x *ResponseValue) GetListValue() *ListValue {
	if x != nil {
		if x, ok := x.Kind.(*ResponseValue_ListValue); ok {
			return x.ListValue
		}
	}
	return nil
...
func (x *ResponseValue) GetBytesValue() []byte {
	if x != nil {
		if x, ok := x.Kind.(*ResponseValue_BytesValue); ok {
			return x.BytesValue
		}
	}
	return nil
...
func (x *ResponseValue) GetCombinedState() *CombinedState {
	if x != nil {
		if x, ok := x.Kind.(*ResponseValue_CombinedState); ok {
...
func (x *ResponseValue) GetOspfMetrics() *OSPFMetrics {
	if x != nil {
		if x, ok := x.Kind.(*ResponseValue_OspfMetrics); ok {
...
func (x *ResponseValue) GetOspfNeighbor() *OSPFNeighbor {
	if x != nil {
		if x, ok := x.Kind.(*ResponseValue_OspfNeighbor); ok {
...
func (x *ResponseValue) GetOspfRoute() *OSPFRoute {
	if x != nil {
		if x, ok := x.Kind.(*ResponseValue_OspfRoute); ok {
			return x.OspfRoute
		}
	}
	return nil
...
func (x *ResponseValue) GetOspfInterface() *OSPFInterface {
	if x != nil {
		if x, ok := x.Kind.(*ResponseValue_OspfInterface); ok {
...
func (x *ResponseValue) GetOspfLsa() *OSPFlsa {
	if x != nil {
		if x, ok := x.Kind.(*ResponseValue_OspfLsa); ok {
			return x.OspfLsa
		}
	}
	return nil
...
func (x *ResponseValue) GetNetworkConfig() *NetworkConfig {
	if x != nil {
		if x, ok := x.Kind.(*ResponseValue_NetworkConfig); ok {
...
func (x *ResponseValue) GetOspfArea() *OSPFArea {
	if x != nil {
		if x, ok := x.Kind.(*ResponseValue_OspfArea); ok {
			return x.OspfArea
		}
	}
	return nil
...
func (x *ResponseValue) GetOspfInterfaceConfig() *OSPFInterfaceConfig {
	if x != nil {
		if x, ok := x.Kind.(*ResponseValue_OspfInterfaceConfig); ok {
...
func (x *ResponseValue) GetInterfaceStats() *InterfaceStats {
	if x != nil {
		if x, ok := x.Kind.(*ResponseValue_InterfaceStats); ok {
...
type ResponseValue_DoubleValue struct {
...
type ResponseValue_StructValue struct {
	StructValue *Struct `protobuf:"bytes,5,opt,name=struct_value,json=structValue,proto3,oneof"`
}

type ResponseValue_ListValue struct {
	ListValue *ListValue `protobuf:"bytes,6,opt,name=list_value,json=listValue,proto3,oneof"`
}

type ResponseValue_BytesValue struct {
	BytesValue []byte `protobuf:"bytes,7,opt,name=bytes_value,json=bytesValue,proto3,oneof"`
}

type ResponseValue_CombinedState struct {
...
type ResponseValue_InterfaceStats struct {
...
type ResponseValue_StaticFrrConfiguration struct {
	StaticFrrConfiguration *StaticFRRConfiguration `protobuf:"bytes,26,opt,name=static_frr_configuration,json=staticFrrConfiguration,proto3,oneof"`
}

func (*ResponseValue_StringValue) isResponseValue_Kind() {}

func (*ResponseValue_IntValue) isResponseValue_Kind() {}

func (*ResponseValue_DoubleValue) isResponseValue_Kind() {}

func (*ResponseValue_BoolValue) isResponseValue_Kind() {}

func (*ResponseValue_StructValue) isResponseValue_Kind() {}

func (*ResponseValue_ListValue) isResponseValue_Kind() {}

func (*ResponseValue_BytesValue) isResponseValue_Kind() {}

func (*ResponseValue_CombinedState) isResponseValue_Kind() {}

func (*ResponseValue_OspfMetrics) isResponseValue_Kind() {}

func (*ResponseValue_OspfNeighbor) isResponseValue_Kind() {}

func (*ResponseValue_OspfRoute) isResponseValue_Kind() {}

func (*ResponseValue_OspfInterface) isResponseValue_Kind() {}

func (*ResponseValue_OspfLsa) isResponseValue_Kind() {}

func (*ResponseValue_NetworkConfig) isResponseValue_Kind() {}

func (*ResponseValue_OspfArea) isResponseValue_Kind() {}

func (*ResponseValue_OspfInterfaceConfig) isResponseValue_Kind() {}

func (*ResponseValue_SystemMetrics) isResponseValue_Kind() {}

func (*ResponseValue_InterfaceStats) isResponseValue_Kind() {}
...
// Struct represents a map of string to ResponseValue (similar to map[string]interface{})
type Struct struct {
	state         protoimpl.MessageState    `protogen:"open.v1"`
	Fields        map[string]*ResponseValue `protobuf:"bytes,1,rep,name=fields,proto3" json:"fields,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Struct) GetFields() map[string]*ResponseValue {
	if x != nil {
		return x.Fields
	}
	return nil
...
type ListValue struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Values        []*ResponseValue       `protobuf:"bytes,1,rep,name=values,proto3" json:"values,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListValue) GetValues() []*ResponseValue {
	if x != nil {
		return x.Values
	}
	return nil
...
const file_protocol_proto_rawDesc = "" +
	...
	"\x04data\x18\x03 \x01(\v2\x1c.communication.ResponseValueR\x04data\"\xb6\r\n" +
	"\rResponseValue\x12#\n" +
	...
	"\x17ospf_nssa_external_data\x18\x19 \x01(\v2#.communication.OSPFNssaExternalDataH\x00R\x14ospfNssaExternalData\x12a\n" +
	"\x18static_frr_configuration\x18\x1a \x01(\v2%.communication.StaticFRRConfigurationH\x00R\x16staticFrrConfigurationB\x06\n" +
	"\x04kind\"\x9c\x01\n" +
	"\x06Struct\x129\n" +
	"\x06fields\x18\x01 \x03(\v2!.communication.Struct.FieldsEntryR\x06fields\x1aW\n" +
	"\vFieldsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x122\n" +
	"\x05value\x18\x02 \x01(\v2\x1c.communication.ResponseValueR\x05value:\x028\x01\"A\n" +
	"\tListValue\x124\n" +
	"\x06values\x18\x01 \x03(\v2\x1c.communication.ResponseValueR\x06values\"\xea\x05\n" +
...
var file_protocol_proto_goTypes = []any{
	...
	(*OspfRouterInfo)(nil),              // 51: communication.OspfRouterInfo
	(*AreaLinkStates)(nil),              // 52: communication.AreaLinkStates
	(*RouterLSA)(nil),                   // 53: communication.RouterLSA
	(*RouterLink)(nil),                  // 54: communication.RouterLink
	nil,                                 // 55: communication.Message.ParamsEntry
	nil,                                 // 56: communication.Command.ParamsEntry
	nil,                                 // 57: communication.Struct.FieldsEntry
	nil,                                 // 58: communication.StaticFRRConfiguration.RouteMapEntry
	nil,                                 // 59: communication.StaticFRRConfiguration.AccessListEntry
	nil,                                 // 60: communication.OSPFRouterData.RouterStatesEntry
	nil,                                 // 61: communication.OSPFRouterArea.LsaEntriesEntry
	nil,                                 // 62: communication.OSPFRouterLSA.RouterLinksEntry
	nil,                                 // 63: communication.OSPFNetworkData.NetStatesEntry
	nil,                                 // 64: communication.NetAreaState.LsaEntriesEntry
	nil,                                 // 65: communication.NetworkLSA.AttachedRoutersEntry
	nil,                                 // 66: communication.OSPFSummaryData.NetStatesEntry
	nil,                                 // 67: communication.OSPFSummaryData.SummaryStatesEntry
	nil,                                 // 68: communication.SummaryAreaState.LsaEntriesEntry
	nil,                                 // 69: communication.OSPFAsbrSummaryData.AsbrSummaryStatesEntry
	nil,                                 // 70: communication.OSPFExternalData.AsExternalLinkStatesEntry
	nil,                                 // 71: communication.OSPFNssaExternalData.NssaExternalLinkStatesEntry
	nil,                                 // 72: communication.NssaExternalArea.DataEntry
	nil,                                 // 73: communication.OspfRouterInfo.RouterLinkStatesEntry
	nil,                                 // 74: communication.AreaLinkStates.RouterLsasEntry
	nil,                                 // 75: communication.RouterLSA.RouterLinksEntry
	(*timestamppb.Timestamp)(nil),       // 76: google.protobuf.Timestamp
}
var file_protocol_proto_depIdxs = []int32{
	55, // 0: communication.Message.params:type_name -> communication.Message.ParamsEntry
	56, // 1: communication.Command.params:type_name -> communication.Command.ParamsEntry
	3,  // 2: communication.Response.data:type_name -> communication.ResponseValue
	4,  // 3: communication.ResponseValue.struct_value:type_name -> communication.Struct
	5,  // 4: communication.ResponseValue.list_value:type_name -> communication.ListValue
	16, // 5: communication.ResponseValue.combined_state:type_name -> communication.CombinedState
	17, // 6: communication.ResponseValue.ospf_metrics:type_name -> communication.OSPFMetrics
	18, // 7: communication.ResponseValue.ospf_neighbor:type_name -> communication.OSPFNeighbor
	19, // 8: communication.ResponseValue.ospf_route:type_name -> communication.OSPFRoute
	20, // 9: communication.ResponseValue.ospf_interface:type_name -> communication.OSPFInterface
	21, // 10: communication.ResponseValue.ospf_lsa:type_name -> communication.OSPFlsa
	22, // 11: communication.ResponseValue.network_config:type_name -> communication.NetworkConfig
	23, // 12: communication.ResponseValue.ospf_area:type_name -> communication.OSPFArea
	24, // 13: communication.ResponseValue.ospf_interface_config:type_name -> communication.OSPFInterfaceConfig
	25, // 14: communication.ResponseValue.system_metrics:type_name -> communication.SystemMetrics
	26, // 15: communication.ResponseValue.interface_stats:type_name -> communication.InterfaceStats
	44, // 16: communication.ResponseValue.anomalies:type_name -> communication.Anomalies
	27, // 17: communication.ResponseValue.ospf_router_data:type_name -> communication.OSPFRouterData
	31, // 18: communication.ResponseValue.ospf_network_data:type_name -> communication.OSPFNetworkData
	35, // 19: communication.ResponseValue.ospf_summary_data:type_name -> communication.OSPFSummaryData
	38, // 20: communication.ResponseValue.ospf_asbr_summary_data:type_name -> communication.OSPFAsbrSummaryData
	39, // 21: communication.ResponseValue.ospf_external_data:type_name -> communication.OSPFExternalData
	41, // 22: communication.ResponseValue.ospf_nssa_external_data:type_name -> communication.OSPFNssaExternalData
	6,  // 23: communication.ResponseValue.static_frr_configuration:type_name -> communication.StaticFRRConfiguration
	57, // 24: communication.Struct.fields:type_name -> communication.Struct.FieldsEntry
	3,  // 25: communication.ListValue.values:type_name -> communication.ResponseValue
	7,  // 26: communication.StaticFRRConfiguration.interfaces:type_name -> communication.Interface
	8,  // 27: communication.StaticFRRConfiguration.static_routes:type_name -> communication.StaticRoute
	9,  // 28: communication.StaticFRRConfiguration.ospf_config:type_name -> communication.OSPFConfig
	58, // 29: communication.StaticFRRConfiguration.route_map:type_name -> communication.StaticFRRConfiguration.RouteMapEntry
	59, // 30: communication.StaticFRRConfiguration.access_list:type_name -> communication.StaticFRRConfiguration.AccessListEntry
	15, // 31: communication.Interface.ip_address:type_name -> communication.IPPrefix
	15, // 32: communication.StaticRoute.ip_prefix:type_name -> communication.IPPrefix
	10, // 33: communication.OSPFConfig.redistribution:type_name -> communication.Redistribution
	11, // 34: communication.OSPFConfig.area:type_name -> communication.Area
	14, // 35: communication.AccessList.access_list_items:type_name -> communication.AccessListItem
	15, // 36: communication.AccessListItem.ip_prefix:type_name -> communication.IPPrefix
	76, // 37: communication.CombinedState.timestamp:type_name -> google.protobuf.Timestamp
	17, // 38: communication.CombinedState.ospf:type_name -> communication.OSPFMetrics
	22, // 39: communication.CombinedState.config:type_name -> communication.NetworkConfig
	25, // 40: communication.CombinedState.system:type_name -> communication.SystemMetrics
	18, // 41: communication.OSPFMetrics.neighbors:type_name -> communication.OSPFNeighbor
	19, // 42: communication.OSPFMetrics.routes:type_name -> communication.OSPFRoute
	20, // 43: communication.OSPFMetrics.interfaces:type_name -> communication.OSPFInterface
	21, // 44: communication.OSPFMetrics.lsas:type_name -> communication.OSPFlsa
	23, // 45: communication.NetworkConfig.areas:type_name -> communication.OSPFArea
	24, // 46: communication.NetworkConfig.interfaces:type_name -> communication.OSPFInterfaceConfig
	26, // 47: communication.SystemMetrics.network_stats:type_name -> communication.InterfaceStats
	60, // 48: communication.OSPFRouterData.router_states:type_name -> communication.OSPFRouterData.RouterStatesEntry
	61, // 49: communication.OSPFRouterArea.lsa_entries:type_name -> communication.OSPFRouterArea.LsaEntriesEntry
	62, // 50: communication.OSPFRouterLSA.router_links:type_name -> communication.OSPFRouterLSA.RouterLinksEntry
	63, // 51: communication.OSPFNetworkData.net_states:type_name -> communication.OSPFNetworkData.NetStatesEntry
	64, // 52: communication.NetAreaState.lsa_entries:type_name -> communication.NetAreaState.LsaEntriesEntry
	65, // 53: communication.NetworkLSA.attached_routers:type_name -> communication.NetworkLSA.AttachedRoutersEntry
	66, // 54: communication.OSPFSummaryData.net_states:type_name -> communication.OSPFSummaryData.NetStatesEntry
	67, // 55: communication.OSPFSummaryData.summary_states:type_name -> communication.OSPFSummaryData.SummaryStatesEntry
	68, // 56: communication.SummaryAreaState.lsa_entries:type_name -> communication.SummaryAreaState.LsaEntriesEntry
	69, // 57: communication.OSPFAsbrSummaryData.asbr_summary_states:type_name -> communication.OSPFAsbrSummaryData.AsbrSummaryStatesEntry
	70, // 58: communication.OSPFExternalData.as_external_link_states:type_name -> communication.OSPFExternalData.AsExternalLinkStatesEntry
	71, // 59: communication.OSPFNssaExternalData.nssa_external_link_states:type_name -> communication.OSPFNssaExternalData.NssaExternalLinkStatesEntry
	72, // 60: communication.NssaExternalArea.data:type_name -> communication.NssaExternalArea.DataEntry
	47, // 61: communication.Anomalies.overadvertised_routes:type_name -> communication.AnomalyOveradvertisedRoute
	48, // 62: communication.Anomalies.underadvertised_routes:type_name -> communication.AnomalyUnderadvertisedRoute
	49, // 63: communication.Anomalies.duplicate_routes:type_name -> communication.AnomalyDuplicateRoute
	50, // 64: communication.Anomalies.misconfigured_routes:type_name -> communication.AnomalyMisconfiguredRoute
	76, // 65: communication.AnomalyOveradvertisedRoute.timestamp:type_name -> google.protobuf.Timestamp
	46, // 66: communication.AnomalyOveradvertisedRoute.router:type_name -> communication.RouterAttribute
	76, // 67: communication.AnomalyUnderadvertisedRoute.timestamp:type_name -> google.protobuf.Timestamp
	46, // 68: communication.AnomalyUnderadvertisedRoute.router:type_name -> communication.RouterAttribute
	76, // 69: communication.AnomalyDuplicateRoute.timestamp:type_name -> google.protobuf.Timestamp
	46, // 70: communication.AnomalyDuplicateRoute.router:type_name -> communication.RouterAttribute
	76, // 71: communication.AnomalyMisconfiguredRoute.timestamp:type_name -> google.protobuf.Timestamp
	46, // 72: communication.AnomalyMisconfiguredRoute.router:type_name -> communication.RouterAttribute
	73, // 73: communication.OspfRouterInfo.router_link_states:type_name -> communication.OspfRouterInfo.RouterLinkStatesEntry
	74, // 74: communication.AreaLinkStates.router_lsas:type_name -> communication.AreaLinkStates.RouterLsasEntry
	75, // 75: communication.RouterLSA.router_links:type_name -> communication.RouterLSA.RouterLinksEntry
	3,  // 76: communication.Message.ParamsEntry.value:type_name -> communication.ResponseValue
	3,  // 77: communication.Command.ParamsEntry.value:type_name -> communication.ResponseValue
	3,  // 78: communication.Struct.FieldsEntry.value:type_name -> communication.ResponseValue
	12, // 79: communication.StaticFRRConfiguration.RouteMapEntry.value:type_name -> communication.RouteMap
	13, // 80: communication.StaticFRRConfiguration.AccessListEntry.value:type_name -> communication.AccessList
	28, // 81: communication.OSPFRouterData.RouterStatesEntry.value:type_name -> communication.OSPFRouterArea
	29, // 82: communication.OSPFRouterArea.LsaEntriesEntry.value:type_name -> communication.OSPFRouterLSA
	30, // 83: communication.OSPFRouterLSA.RouterLinksEntry.value:type_name -> communication.OSPFRouterLSALink
	32, // 84: communication.OSPFNetworkData.NetStatesEntry.value:type_name -> communication.NetAreaState
	33, // 85: communication.NetAreaState.LsaEntriesEntry.value:type_name -> communication.NetworkLSA
	34, // 86: communication.NetworkLSA.AttachedRoutersEntry.value:type_name -> communication.AttachedRouter
	32, // 87: communication.OSPFSummaryData.NetStatesEntry.value:type_name -> communication.NetAreaState
	36, // 88: communication.OSPFSummaryData.SummaryStatesEntry.value:type_name -> communication.SummaryAreaState
	37, // 89: communication.SummaryAreaState.LsaEntriesEntry.value:type_name -> communication.SummaryLSA
	36, // 90: communication.OSPFAsbrSummaryData.AsbrSummaryStatesEntry.value:type_name -> communication.SummaryAreaState
	40, // 91: communication.OSPFExternalData.AsExternalLinkStatesEntry.value:type_name -> communication.ExternalLSA
	42, // 92: communication.OSPFNssaExternalData.NssaExternalLinkStatesEntry.value:type_name -> communication.NssaExternalArea
	43, // 93: communication.NssaExternalArea.DataEntry.value:type_name -> communication.NssaExternalLSA
	52, // 94: communication.OspfRouterInfo.RouterLinkStatesEntry.value:type_name -> communication.AreaLinkStates
	53, // 95: communication.AreaLinkStates.RouterLsasEntry.value:type_name -> communication.RouterLSA
	54, // 96: communication.RouterLSA.RouterLinksEntry.value:type_name -> communication.RouterLink
...
func file_protocol_proto_init() {
	...
	file_protocol_proto_msgTypes[3].OneofWrappers = []any{
		...
		(*ResponseValue_DoubleValue)(nil),
		(*ResponseValue_BoolValue)(nil),
		(*ResponseValue_StructValue)(nil),
		(*ResponseValue_ListValue)(nil),
		(*ResponseValue_BytesValue)(nil),
		(*ResponseValue_CombinedState)(nil),
		(*ResponseValue_OspfMetrics)(nil),
		(*ResponseValue_OspfNeighbor)(nil),
		(*ResponseValue_OspfRoute)(nil),
		(*ResponseValue_OspfInterface)(nil),
		(*ResponseValue_OspfLsa)(nil),
		(*ResponseValue_NetworkConfig)(nil),
		(*ResponseValue_OspfArea)(nil),
		(*ResponseValue_OspfInterfaceConfig)(nil),
		(*ResponseValue_SystemMetrics)(nil),
		(*ResponseValue_InterfaceStats)(nil),
	...
	file_protocol_proto_msgTypes[54].OneofWrappers = []any{}
	type x struct{}
