...
type ResponseValue_RoutingInformationBase struct {
	RoutingInformationBase *RoutingInformationBase `protobuf:"bytes,13,opt,name=routing_information_base,json=routingInformationBase,proto3,oneof"`
}
...
type FullFRRData struct {
	...
	RoutingInformationBase *RoutingInformationBase `protobuf:"bytes,11,opt,name=routing_information_base,json=routingInformationBase,proto3" json:"routing_information_base,omitempty"`
...
const file_protocol_proto_rawDesc = "" +
	...
	"\x04data\x18\x03 \x01(\v2\x1c.communication.ResponseValueR\x04data\"\x89\t\n" +
	"\rResponseValue\x12#\n" +
	...
	"\x04cost\x18\x05 \x01(\x05R\x04cost\"\x86\b\n" +
	"\vFullFRRData\x12@\n" +
	...
	"interfaces\x12_\n" +
	"\x18routing_information_base\x18\v \x01(\v2%.communication.RoutingInformationBaseR\x16routingInformationBase\x12_\n" +
...
var file_protocol_proto_goTypes = []any{
	...
	(*RoutingInformationBase)(nil),      // 53: communication.RoutingInformationBase
	...
	nil,                                 // 88: communication.RoutingInformationBase.RoutesEntry
...
var file_protocol_proto_depIdxs = []int32{
	...
	53,  // 14: communication.ResponseValue.routing_information_base:type_name -> communication.RoutingInformationBase
	...
	53,  // 40: communication.FullFRRData.routing_information_base:type_name -> communication.RoutingInformationBase
	...
	88,  // 73: communication.RoutingInformationBase.routes:type_name -> communication.RoutingInformationBase.RoutesEntry
	...
	54,  // 111: communication.RoutingInformationBase.RoutesEntry.value:type_name -> communication.RouteEntry
