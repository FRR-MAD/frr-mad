...
type ResponseValue_OspfDatabase struct {
	...
	OspfDatabase *OSPFDatabase `protobuf:"bytes,5,opt,name=ospf_database,json=ospfDatabase,proto3,oneof"`
}

type ResponseValue_OspfNetworkData struct {
	OspfNetworkData *OSPFNetworkData `protobuf:"bytes,6,opt,name=ospf_network_data,json=ospfNetworkData,proto3,oneof"`
}

type ResponseValue_OspfSummaryData struct {
	OspfSummaryData *OSPFSummaryData `protobuf:"bytes,7,opt,name=ospf_summary_data,json=ospfSummaryData,proto3,oneof"`
}

type ResponseValue_OspfAsbrSummaryData struct {
	OspfAsbrSummaryData *OSPFAsbrSummaryData `protobuf:"bytes,8,opt,name=ospf_asbr_summary_data,json=ospfAsbrSummaryData,proto3,oneof"`
}

type ResponseValue_OspfExternalData struct {
	OspfExternalData *OSPFExternalData `protobuf:"bytes,9,opt,name=ospf_external_data,json=ospfExternalData,proto3,oneof"`
}

type ResponseValue_OspfNssaExternalData struct {
	OspfNssaExternalData *OSPFNssaExternalData `protobuf:"bytes,10,opt,name=ospf_nssa_external_data,json=ospfNssaExternalData,proto3,oneof"`
}

type ResponseValue_OspfExternalAll struct {
	OspfExternalAll *OSPFExternalAll `protobuf:"bytes,11,opt,name=ospf_external_all,json=ospfExternalAll,proto3,oneof"`
}

type ResponseValue_OspfNssaExternalAll struct {
	OspfNssaExternalAll *OSPFNssaExternalAll `protobuf:"bytes,12,opt,name=ospf_nssa_external_all,json=ospfNssaExternalAll,proto3,oneof"`
}

type ResponseValue_OspfNeighbors struct {
	OspfNeighbors *OSPFNeighbors `protobuf:"bytes,13,opt,name=ospf_neighbors,json=ospfNeighbors,proto3,oneof"`
}

type ResponseValue_Interfaces struct {
	Interfaces *InterfaceList `protobuf:"bytes,14,opt,name=interfaces,proto3,oneof"`
}

type ResponseValue_RoutingInformationBase struct {
	RoutingInformationBase *RoutingInformationBase `protobuf:"bytes,15,opt,name=routing_information_base,json=routingInformationBase,proto3,oneof"`
}

type ResponseValue_StaticFrrConfiguration struct {
	StaticFrrConfiguration *StaticFRRConfiguration `protobuf:"bytes,16,opt,name=static_frr_configuration,json=staticFrrConfiguration,proto3,oneof"`
}
...
type ResponseValue_FrrRouterData struct {
	FrrRouterData *FRRRouterData `protobuf:"bytes,18,opt,name=frr_router_data,json=frrRouterData,proto3,oneof"`
}

type ResponseValue_OspfRouterData struct {
	OspfRouterData *OSPFRouterData `protobuf:"bytes,19,opt,name=ospf_router_data,json=ospfRouterData,proto3,oneof"`
}
...
type FullFRRData struct {
	...
	OspfRouterDataAll      *OSPFRouterData         `protobuf:"bytes,3,opt,name=ospf_router_data_all,json=ospfRouterDataAll,proto3" json:"ospf_router_data_all,omitempty"`
	OspfNetworkData        *OSPFNetworkData        `protobuf:"bytes,4,opt,name=ospf_network_data,json=ospfNetworkData,proto3" json:"ospf_network_data,omitempty"`
	OspfNetworkDataAll     *OSPFNetworkData        `protobuf:"bytes,5,opt,name=ospf_network_data_all,json=ospfNetworkDataAll,proto3" json:"ospf_network_data_all,omitempty"`
	OspfSummaryData        *OSPFSummaryData        `protobuf:"bytes,6,opt,name=ospf_summary_data,json=ospfSummaryData,proto3" json:"ospf_summary_data,omitempty"`
	OspfSummaryDataAll     *OSPFSummaryData        `protobuf:"bytes,7,opt,name=ospf_summary_data_all,json=ospfSummaryDataAll,proto3" json:"ospf_summary_data_all,omitempty"`
	OspfAsbrSummaryData    *OSPFAsbrSummaryData    `protobuf:"bytes,8,opt,name=ospf_asbr_summary_data,json=ospfAsbrSummaryData,proto3" json:"ospf_asbr_summary_data,omitempty"`
	OspfExternalData       *OSPFExternalData       `protobuf:"bytes,9,opt,name=ospf_external_data,json=ospfExternalData,proto3" json:"ospf_external_data,omitempty"`
	OspfNssaExternalData   *OSPFNssaExternalData   `protobuf:"bytes,10,opt,name=ospf_nssa_external_data,json=ospfNssaExternalData,proto3" json:"ospf_nssa_external_data,omitempty"`
	OspfExternalAll        *OSPFExternalAll        `protobuf:"bytes,11,opt,name=ospf_external_all,json=ospfExternalAll,proto3" json:"ospf_external_all,omitempty"`
	OspfNssaExternalAll    *OSPFNssaExternalAll    `protobuf:"bytes,12,opt,name=ospf_nssa_external_all,json=ospfNssaExternalAll,proto3" json:"ospf_nssa_external_all,omitempty"`
	OspfNeighbors          *OSPFNeighbors          `protobuf:"bytes,13,opt,name=ospf_neighbors,json=ospfNeighbors,proto3" json:"ospf_neighbors,omitempty"`
	Interfaces             *InterfaceList          `protobuf:"bytes,14,opt,name=interfaces,proto3" json:"interfaces,omitempty"`
	RoutingInformationBase *RoutingInformationBase `protobuf:"bytes,15,opt,name=routing_information_base,json=routingInformationBase,proto3" json:"routing_information_base,omitempty"`
	StaticFrrConfiguration *StaticFRRConfiguration `protobuf:"bytes,16,opt,name=static_frr_configuration,json=staticFrrConfiguration,proto3" json:"static_frr_configuration,omitempty"`
	SystemMetrics          *SystemMetrics          `protobuf:"bytes,17,opt,name=system_metrics,json=systemMetrics,proto3" json:"system_metrics,omitempty"`
	FrrRouterData          *FRRRouterData          `protobuf:"bytes,18,opt,name=frr_router_data,json=frrRouterData,proto3" json:"frr_router_data,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
type Anomalies struct {
	...
	UnadvertisedRoutes   []*AnomalyUnadvertisedRoute   `protobuf:"bytes,2,rep,name=unadvertised_routes,json=unadvertisedRoutes,proto3" json:"unadvertised_routes,omitempty"`
...
func (x *Anomalies) GetUnadvertisedRoutes() []*AnomalyUnadvertisedRoute {
	if x != nil {
		return x.UnadvertisedRoutes
	}
	return nil
}
...
type AnomalyUnadvertisedRoute struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	Timestamp        *timestamppb.Timestamp `protobuf:"bytes,1,opt,name=timestamp,proto3" json:"timestamp,omitempty"`
	Service          string                 `protobuf:"bytes,2,opt,name=service,proto3" json:"service,omitempty"`
	IsAdvertised     string                 `protobuf:"bytes,3,opt,name=is_advertised,json=isAdvertised,proto3" json:"is_advertised,omitempty"`
...
func (x *AnomalyUnadvertisedRoute) Reset() {
	*x = AnomalyUnadvertisedRoute{}
	mi := &file_protocol_proto_msgTypes[75]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AnomalyUnadvertisedRoute) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AnomalyUnadvertisedRoute) ProtoMessage() {}

func (x *AnomalyUnadvertisedRoute) ProtoReflect() protoreflect.Message {
	mi := &file_protocol_proto_msgTypes[75]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AnomalyUnadvertisedRoute.ProtoReflect.Descriptor instead.
func (*AnomalyUnadvertisedRoute) Descriptor() ([]byte, []int) {
	return file_protocol_proto_rawDescGZIP(), []int{75}
}

func (x *AnomalyUnadvertisedRoute) GetTimestamp() *timestamppb.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
func (x *AnomalyUnadvertisedRoute) GetService() string {
	if x != nil {
		return x.Service
	}
	return ""
...
func (x *AnomalyUnadvertisedRoute) GetIsAdvertised() string {
	if x != nil {
		return x.IsAdvertised
	}
	return ""
...
func (x *AnomalyUnadvertisedRoute) GetShouldAdvertised() string {
	if x != nil {
		return x.ShouldAdvertised
	}
	return ""
...
func (x *AnomalyUnadvertisedRoute) GetRouter() *RouterAttribute {
	if x != nil {
		return x.Router
	}
	return nil
...
func (*RouterLink) Descriptor() ([]byte, []int) {
	return file_protocol_proto_rawDescGZIP(), []int{81}
}
...
const file_protocol_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xcb\v\n" +
	"\rResponseValue\x12#\n" +
	...
	"\x19peer_interface_to_address\x18\x04 \x01(\v2\x1f.communication.PeerInterfaceMapH\x00R\x16peerInterfaceToAddress\x12B\n" +
	"\rospf_database\x18\x05 \x01(\v2\x1b.communication.OSPFDatabaseH\x00R\fospfDatabase\x12L\n" +
	"\x11ospf_network_data\x18\x06 \x01(\v2\x1e.communication.OSPFNetworkDataH\x00R\x0fospfNetworkData\x12L\n" +
	"\x11ospf_summary_data\x18\a \x01(\v2\x1e.communication.OSPFSummaryDataH\x00R\x0fospfSummaryData\x12Y\n" +
	"\x16ospf_asbr_summary_data\x18\b \x01(\v2\".communication.OSPFAsbrSummaryDataH\x00R\x13ospfAsbrSummaryData\x12O\n" +
	"\x12ospf_external_data\x18\t \x01(\v2\x1f.communication.OSPFExternalDataH\x00R\x10ospfExternalData\x12\\\n" +
	"\x17ospf_nssa_external_data\x18\n" +
	" \x01(\v2#.communication.OSPFNssaExternalDataH\x00R\x14ospfNssaExternalData\x12L\n" +
	"\x11ospf_external_all\x18\v \x01(\v2\x1e.communication.OSPFExternalAllH\x00R\x0fospfExternalAll\x12Y\n" +
	"\x16ospf_nssa_external_all\x18\f \x01(\v2\".communication.OSPFNssaExternalAllH\x00R\x13ospfNssaExternalAll\x12E\n" +
	"\x0eospf_neighbors\x18\r \x01(\v2\x1c.communication.OSPFNeighborsH\x00R\rospfNeighbors\x12>\n" +
	"\n" +
	"interfaces\x18\x0e \x01(\v2\x1c.communication.InterfaceListH\x00R\n" +
	"interfaces\x12a\n" +
	"\x18routing_information_base\x18\x0f \x01(\v2%.communication.RoutingInformationBaseH\x00R\x16routingInformationBase\x12a\n" +
	"\x18static_frr_configuration\x18\x10 \x01(\v2%.communication.StaticFRRConfigurationH\x00R\x16staticFrrConfiguration\x12E\n" +
	"\x0esystem_metrics\x18\x11 \x01(\v2\x1c.communication.SystemMetricsH\x00R\rsystemMetrics\x12F\n" +
	"\x0ffrr_router_data\x18\x12 \x01(\v2\x1c.communication.FRRRouterDataH\x00R\rfrrRouterData\x12I\n" +
	"\x10ospf_router_data\x18\x13 \x01(\v2\x1d.communication.OSPFRouterDataH\x00R\x0eospfRouterDataB\x06\n" +
	"\x04kind\"\xea\x05\n" +
	...
	"\x04cost\x18\x05 \x01(\x05R\x04cost\"\x9f\v\n" +
	"\vFullFRRData\x12@\n" +
	"\rospf_database\x18\x01 \x01(\v2\x1b.communication.OSPFDatabaseR\fospfDatabase\x12G\n" +
	"\x10ospf_router_data\x18\x02 \x01(\v2\x1d.communication.OSPFRouterDataR\x0eospfRouterData\x12N\n" +
	"\x14ospf_router_data_all\x18\x03 \x01(\v2\x1d.communication.OSPFRouterDataR\x11ospfRouterDataAll\x12J\n" +
	"\x11ospf_network_data\x18\x04 \x01(\v2\x1e.communication.OSPFNetworkDataR\x0fospfNetworkData\x12Q\n" +
	"\x15ospf_network_data_all\x18\x05 \x01(\v2\x1e.communication.OSPFNetworkDataR\x12ospfNetworkDataAll\x12J\n" +
	"\x11ospf_summary_data\x18\x06 \x01(\v2\x1e.communication.OSPFSummaryDataR\x0fospfSummaryData\x12Q\n" +
	"\x15ospf_summary_data_all\x18\a \x01(\v2\x1e.communication.OSPFSummaryDataR\x12ospfSummaryDataAll\x12W\n" +
	"\x16ospf_asbr_summary_data\x18\b \x01(\v2\".communication.OSPFAsbrSummaryDataR\x13ospfAsbrSummaryData\x12M\n" +
	"\x12ospf_external_data\x18\t \x01(\v2\x1f.communication.OSPFExternalDataR\x10ospfExternalData\x12Z\n" +
	"\x17ospf_nssa_external_data\x18\n" +
	" \x01(\v2#.communication.OSPFNssaExternalDataR\x14ospfNssaExternalData\x12J\n" +
	"\x11ospf_external_all\x18\v \x01(\v2\x1e.communication.OSPFExternalAllR\x0fospfExternalAll\x12W\n" +
	"\x16ospf_nssa_external_all\x18\f \x01(\v2\".communication.OSPFNssaExternalAllR\x13ospfNssaExternalAll\x12C\n" +
	"\x0eospf_neighbors\x18\r \x01(\v2\x1c.communication.OSPFNeighborsR\rospfNeighbors\x12<\n" +
	"\n" +
	"interfaces\x18\x0e \x01(\v2\x1c.communication.InterfaceListR\n" +
	"interfaces\x12_\n" +
	"\x18routing_information_base\x18\x0f \x01(\v2%.communication.RoutingInformationBaseR\x16routingInformationBase\x12_\n" +
	"\x18static_frr_configuration\x18\x10 \x01(\v2%.communication.StaticFRRConfigurationR\x16staticFrrConfiguration\x12C\n" +
	"\x0esystem_metrics\x18\x11 \x01(\v2\x1c.communication.SystemMetricsR\rsystemMetrics\x12D\n" +
	"\x0ffrr_router_data\x18\x12 \x01(\v2\x1c.communication.FRRRouterDataR\rfrrRouterData\"V\n" +
	...
	"\x11duplicate_entries\x18\a \x03(\v2\x1c.communication.AdvertisementR\x10duplicateEntries\"\xb7\x01\n" +
	"\rAdvertisement\x12*\n" +
	...
	"\bLinkType\x18\x04 \x01(\tR\bLinkType\x12\x18\n" +
	...
	"\x10next_hop_address\x18\x04 \x01(\tR\x0enextHopAddress\"\xf3\x02\n" +
	"\tAnomalies\x12^\n" +
	"\x15overadvertised_routes\x18\x01 \x03(\v2).communication.AnomalyOveradvertisedRouteR\x14overadvertisedRoutes\x12X\n" +
	"\x13unadvertised_routes\x18\x02 \x03(\v2'.communication.AnomalyUnadvertisedRouteR\x12unadvertisedRoutes\x12O\n" +
	...
	"\x06router\x18\x05 \x01(\v2\x1e.communication.RouterAttributeR\x06router\"\xf8\x01\n" +
	"\x18AnomalyUnadvertisedRoute\x128\n" +
	"\ttimestamp\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp\x12\x18\n" +
	"\aservice\x18\x02 \x01(\tR\aservice\x12#\n" +
	"\ris_advertised\x18\x03 \x01(\tR\fisAdvertised\x12+\n" +
	"\x11should_advertised\x18\x04 \x01(\tR\x10shouldAdvertised\x126\n" +
...
var file_protocol_proto_goTypes = []any{
	...
	(*StaticFRRConfiguration)(nil),     // 5: communication.StaticFRRConfiguration
	(*Interface)(nil),                  // 6: communication.Interface
	(*StaticRoute)(nil),                // 7: communication.StaticRoute
	(*OSPFConfig)(nil),                 // 8: communication.OSPFConfig
	(*Redistribution)(nil),             // 9: communication.Redistribution
	(*Area)(nil),                       // 10: communication.Area
	(*RouteMap)(nil),                   // 11: communication.RouteMap
	(*AccessList)(nil),                 // 12: communication.AccessList
	(*AccessListItem)(nil),             // 13: communication.AccessListItem
	(*InterfaceIPPrefix)(nil),          // 14: communication.InterfaceIPPrefix
	(*IPPrefix)(nil),                   // 15: communication.IPPrefix
	(*SystemMetrics)(nil),              // 16: communication.SystemMetrics
	(*NetworkConfig)(nil),              // 17: communication.NetworkConfig
	(*OSPFArea)(nil),                   // 18: communication.OSPFArea
	(*OSPFInterfaceConfig)(nil),        // 19: communication.OSPFInterfaceConfig
	(*FullFRRData)(nil),                // 20: communication.FullFRRData
	(*FRRRouterData)(nil),              // 21: communication.FRRRouterData
	(*OSPFRouterData)(nil),             // 22: communication.OSPFRouterData
	(*OSPFRouterArea)(nil),             // 23: communication.OSPFRouterArea
	(*OSPFRouterLSA)(nil),              // 24: communication.OSPFRouterLSA
	(*OSPFRouterLSALink)(nil),          // 25: communication.OSPFRouterLSALink
	(*OSPFNetworkData)(nil),            // 26: communication.OSPFNetworkData
	(*NetAreaState)(nil),               // 27: communication.NetAreaState
	(*NetworkLSA)(nil),                 // 28: communication.NetworkLSA
	(*AttachedRouter)(nil),             // 29: communication.AttachedRouter
	(*OSPFSummaryData)(nil),            // 30: communication.OSPFSummaryData
	(*SummaryAreaState)(nil),           // 31: communication.SummaryAreaState
	(*SummaryLSA)(nil),                 // 32: communication.SummaryLSA
	(*OSPFAsbrSummaryData)(nil),        // 33: communication.OSPFAsbrSummaryData
	(*OSPFExternalData)(nil),           // 34: communication.OSPFExternalData
	(*ExternalLSA)(nil),                // 35: communication.ExternalLSA
	(*OSPFNssaExternalData)(nil),       // 36: communication.OSPFNssaExternalData
	(*NssaExternalArea)(nil),           // 37: communication.NssaExternalArea
	(*NssaExternalLSA)(nil),            // 38: communication.NssaExternalLSA
	(*OSPFDatabase)(nil),               // 39: communication.OSPFDatabase
	(*OSPFDatabaseArea)(nil),           // 40: communication.OSPFDatabaseArea
	(*BaseLSA)(nil),                    // 41: communication.BaseLSA
	(*RouterDataLSA)(nil),              // 42: communication.RouterDataLSA
	(*NetworkDataLSA)(nil),             // 43: communication.NetworkDataLSA
	(*SummaryDataLSA)(nil),             // 44: communication.SummaryDataLSA
	(*ASBRSummaryLSA)(nil),             // 45: communication.ASBRSummaryLSA
	(*NSSAExternalLSAData)(nil),        // 46: communication.NSSAExternalLSAData
	(*ASExternalLSA)(nil),              // 47: communication.ASExternalLSA
	(*OSPFExternalAll)(nil),            // 48: communication.OSPFExternalAll
	(*ASExternalLinkState)(nil),        // 49: communication.ASExternalLinkState
	(*OSPFNssaExternalAll)(nil),        // 50: communication.OSPFNssaExternalAll
	(*OSPFNeighbors)(nil),              // 51: communication.OSPFNeighbors
	(*NeighborList)(nil),               // 52: communication.NeighborList
	(*Neighbor)(nil),                   // 53: communication.Neighbor
	(*InterfaceList)(nil),              // 54: communication.InterfaceList
	(*SingleInterface)(nil),            // 55: communication.SingleInterface
	(*IpAddress)(nil),                  // 56: communication.IpAddress
	(*EvpnMh)(nil),                     // 57: communication.EvpnMh
	(*RoutingInformationBase)(nil),     // 58: communication.RoutingInformationBase
	(*RouteEntry)(nil),                 // 59: communication.RouteEntry
	(*Route)(nil),                      // 60: communication.Route
	(*Nexthop)(nil),                    // 61: communication.Nexthop
	(*AnomalyAnalysis)(nil),            // 62: communication.AnomalyAnalysis
	(*AnomalyDetection)(nil),           // 63: communication.AnomalyDetection
	(*Advertisement)(nil),              // 64: communication.Advertisement
	(*AccessListAnalyzer)(nil),         // 65: communication.AccessListAnalyzer
	(*ACLEntry)(nil),                   // 66: communication.ACLEntry
	(*StaticList)(nil),                 // 67: communication.StaticList
	(*IntraAreaLsa)(nil),               // 68: communication.IntraAreaLsa
	(*InterAreaLsa)(nil),               // 69: communication.InterAreaLsa
	(*AreaAnalyzer)(nil),               // 70: communication.AreaAnalyzer
	(*RibPrefixes)(nil),                // 71: communication.RibPrefixes
	(*Anomalies)(nil),                  // 72: communication.Anomalies
	(*RouterAttribute)(nil),            // 73: communication.RouterAttribute
	(*AnomalyOveradvertisedRoute)(nil), // 74: communication.AnomalyOveradvertisedRoute
	(*AnomalyUnadvertisedRoute)(nil),   // 75: communication.AnomalyUnadvertisedRoute
	(*AnomalyDuplicateRoute)(nil),      // 76: communication.AnomalyDuplicateRoute
	(*AnomalyMisconfiguredRoute)(nil),  // 77: communication.AnomalyMisconfiguredRoute
	(*OspfRouterInfo)(nil),             // 78: communication.OspfRouterInfo
	(*AreaLinkStates)(nil),             // 79: communication.AreaLinkStates
	(*RouterLSA)(nil),                  // 80: communication.RouterLSA
	(*RouterLink)(nil),                 // 81: communication.RouterLink
	nil,                                // 82: communication.Message.ParamsEntry
	nil,                                // 83: communication.Command.ParamsEntry
	nil,                                // 84: communication.PeerInterfaceMap.PeerInterfaceToAddressEntry
	nil,                                // 85: communication.StaticFRRConfiguration.RouteMapEntry
	nil,                                // 86: communication.StaticFRRConfiguration.AccessListEntry
...
var file_protocol_proto_depIdxs = []int32{
	82,  // 0: communication.Message.params:type_name -> communication.Message.ParamsEntry
	83,  // 1: communication.Command.params:type_name -> communication.Command.ParamsEntry
	4,   // 2: communication.Response.data:type_name -> communication.ResponseValue
	84,  // 3: communication.PeerInterfaceMap.peer_interface_to_address:type_name -> communication.PeerInterfaceMap.PeerInterfaceToAddressEntry
	72,  // 4: communication.ResponseValue.anomalies:type_name -> communication.Anomalies
	63,  // 5: communication.ResponseValue.anomaly:type_name -> communication.AnomalyDetection
	3,   // 6: communication.ResponseValue.peer_interface_to_address:type_name -> communication.PeerInterfaceMap
	39,  // 7: communication.ResponseValue.ospf_database:type_name -> communication.OSPFDatabase
	26,  // 8: communication.ResponseValue.ospf_network_data:type_name -> communication.OSPFNetworkData
	30,  // 9: communication.ResponseValue.ospf_summary_data:type_name -> communication.OSPFSummaryData
	33,  // 10: communication.ResponseValue.ospf_asbr_summary_data:type_name -> communication.OSPFAsbrSummaryData
	34,  // 11: communication.ResponseValue.ospf_external_data:type_name -> communication.OSPFExternalData
	36,  // 12: communication.ResponseValue.ospf_nssa_external_data:type_name -> communication.OSPFNssaExternalData
	48,  // 13: communication.ResponseValue.ospf_external_all:type_name -> communication.OSPFExternalAll
	50,  // 14: communication.ResponseValue.ospf_nssa_external_all:type_name -> communication.OSPFNssaExternalAll
	51,  // 15: communication.ResponseValue.ospf_neighbors:type_name -> communication.OSPFNeighbors
	54,  // 16: communication.ResponseValue.interfaces:type_name -> communication.InterfaceList
	58,  // 17: communication.ResponseValue.routing_information_base:type_name -> communication.RoutingInformationBase
	5,   // 18: communication.ResponseValue.static_frr_configuration:type_name -> communication.StaticFRRConfiguration
	16,  // 19: communication.ResponseValue.system_metrics:type_name -> communication.SystemMetrics
	21,  // 20: communication.ResponseValue.frr_router_data:type_name -> communication.FRRRouterData
	22,  // 21: communication.ResponseValue.ospf_router_data:type_name -> communication.OSPFRouterData
	6,   // 22: communication.StaticFRRConfiguration.interfaces:type_name -> communication.Interface
	7,   // 23: communication.StaticFRRConfiguration.static_routes:type_name -> communication.StaticRoute
	8,   // 24: communication.StaticFRRConfiguration.ospf_config:type_name -> communication.OSPFConfig
	85,  // 25: communication.StaticFRRConfiguration.route_map:type_name -> communication.StaticFRRConfiguration.RouteMapEntry
	86,  // 26: communication.StaticFRRConfiguration.access_list:type_name -> communication.StaticFRRConfiguration.AccessListEntry
	14,  // 27: communication.Interface.interface_ip_prefixes:type_name -> communication.InterfaceIPPrefix
	15,  // 28: communication.StaticRoute.ip_prefix:type_name -> communication.IPPrefix
	9,   // 29: communication.OSPFConfig.redistribution:type_name -> communication.Redistribution
	10,  // 30: communication.OSPFConfig.area:type_name -> communication.Area
	13,  // 31: communication.AccessList.access_list_items:type_name -> communication.AccessListItem
	15,  // 32: communication.AccessListItem.ip_prefix:type_name -> communication.IPPrefix
	15,  // 33: communication.InterfaceIPPrefix.ip_prefix:type_name -> communication.IPPrefix
	15,  // 34: communication.InterfaceIPPrefix.peer_ip_prefix:type_name -> communication.IPPrefix
	18,  // 35: communication.NetworkConfig.areas:type_name -> communication.OSPFArea
	19,  // 36: communication.NetworkConfig.interfaces:type_name -> communication.OSPFInterfaceConfig
	39,  // 37: communication.FullFRRData.ospf_database:type_name -> communication.OSPFDatabase
	22,  // 38: communication.FullFRRData.ospf_router_data:type_name -> communication.OSPFRouterData
	22,  // 39: communication.FullFRRData.ospf_router_data_all:type_name -> communication.OSPFRouterData
	26,  // 40: communication.FullFRRData.ospf_network_data:type_name -> communication.OSPFNetworkData
	26,  // 41: communication.FullFRRData.ospf_network_data_all:type_name -> communication.OSPFNetworkData
	30,  // 42: communication.FullFRRData.ospf_summary_data:type_name -> communication.OSPFSummaryData
	30,  // 43: communication.FullFRRData.ospf_summary_data_all:type_name -> communication.OSPFSummaryData
	33,  // 44: communication.FullFRRData.ospf_asbr_summary_data:type_name -> communication.OSPFAsbrSummaryData
	34,  // 45: communication.FullFRRData.ospf_external_data:type_name -> communication.OSPFExternalData
	36,  // 46: communication.FullFRRData.ospf_nssa_external_data:type_name -> communication.OSPFNssaExternalData
	48,  // 47: communication.FullFRRData.ospf_external_all:type_name -> communication.OSPFExternalAll
	50,  // 48: communication.FullFRRData.ospf_nssa_external_all:type_name -> communication.OSPFNssaExternalAll
	51,  // 49: communication.FullFRRData.ospf_neighbors:type_name -> communication.OSPFNeighbors
	54,  // 50: communication.FullFRRData.interfaces:type_name -> communication.InterfaceList
	58,  // 51: communication.FullFRRData.routing_information_base:type_name -> communication.RoutingInformationBase
	5,   // 52: communication.FullFRRData.static_frr_configuration:type_name -> communication.StaticFRRConfiguration
	16,  // 53: communication.FullFRRData.system_metrics:type_name -> communication.SystemMetrics
	21,  // 54: communication.FullFRRData.frr_router_data:type_name -> communication.FRRRouterData
	87,  // 55: communication.OSPFRouterData.router_states:type_name -> communication.OSPFRouterData.RouterStatesEntry
	88,  // 56: communication.OSPFRouterArea.lsa_entries:type_name -> communication.OSPFRouterArea.LsaEntriesEntry
	89,  // 57: communication.OSPFRouterLSA.router_links:type_name -> communication.OSPFRouterLSA.RouterLinksEntry
	90,  // 58: communication.OSPFNetworkData.net_states:type_name -> communication.OSPFNetworkData.NetStatesEntry
	91,  // 59: communication.NetAreaState.lsa_entries:type_name -> communication.NetAreaState.LsaEntriesEntry
	92,  // 60: communication.NetworkLSA.attached_routers:type_name -> communication.NetworkLSA.AttachedRoutersEntry
	93,  // 61: communication.OSPFSummaryData.net_states:type_name -> communication.OSPFSummaryData.NetStatesEntry
	94,  // 62: communication.OSPFSummaryData.summary_states:type_name -> communication.OSPFSummaryData.SummaryStatesEntry
	95,  // 63: communication.SummaryAreaState.lsa_entries:type_name -> communication.SummaryAreaState.LsaEntriesEntry
	96,  // 64: communication.OSPFAsbrSummaryData.asbr_summary_states:type_name -> communication.OSPFAsbrSummaryData.AsbrSummaryStatesEntry
	97,  // 65: communication.OSPFExternalData.as_external_link_states:type_name -> communication.OSPFExternalData.AsExternalLinkStatesEntry
	98,  // 66: communication.OSPFNssaExternalData.nssa_external_link_states:type_name -> communication.OSPFNssaExternalData.NssaExternalLinkStatesEntry
	99,  // 67: communication.NssaExternalArea.data:type_name -> communication.NssaExternalArea.DataEntry
	100, // 68: communication.OSPFDatabase.areas:type_name -> communication.OSPFDatabase.AreasEntry
	47,  // 69: communication.OSPFDatabase.as_external_link_states:type_name -> communication.ASExternalLSA
	42,  // 70: communication.OSPFDatabaseArea.router_link_states:type_name -> communication.RouterDataLSA
	43,  // 71: communication.OSPFDatabaseArea.network_link_states:type_name -> communication.NetworkDataLSA
	44,  // 72: communication.OSPFDatabaseArea.summary_link_states:type_name -> communication.SummaryDataLSA
	45,  // 73: communication.OSPFDatabaseArea.asbr_summary_link_states:type_name -> communication.ASBRSummaryLSA
	46,  // 74: communication.OSPFDatabaseArea.nssa_external_link_states:type_name -> communication.NSSAExternalLSAData
	41,  // 75: communication.RouterDataLSA.base:type_name -> communication.BaseLSA
	41,  // 76: communication.NetworkDataLSA.base:type_name -> communication.BaseLSA
	41,  // 77: communication.SummaryDataLSA.base:type_name -> communication.BaseLSA
	41,  // 78: communication.ASBRSummaryLSA.base:type_name -> communication.BaseLSA
	41,  // 79: communication.NSSAExternalLSAData.base:type_name -> communication.BaseLSA
	41,  // 80: communication.ASExternalLSA.base:type_name -> communication.BaseLSA
	49,  // 81: communication.OSPFExternalAll.as_external_link_states:type_name -> communication.ASExternalLinkState
	101, // 82: communication.OSPFNssaExternalAll.nssa_external_all_link_states:type_name -> communication.OSPFNssaExternalAll.NssaExternalAllLinkStatesEntry
	102, // 83: communication.OSPFNeighbors.neighbors:type_name -> communication.OSPFNeighbors.NeighborsEntry
	53,  // 84: communication.NeighborList.neighbors:type_name -> communication.Neighbor
	103, // 85: communication.InterfaceList.interfaces:type_name -> communication.InterfaceList.InterfacesEntry
	56,  // 86: communication.SingleInterface.ip_addresses:type_name -> communication.IpAddress
	57,  // 87: communication.SingleInterface.evpn_mh:type_name -> communication.EvpnMh
	104, // 88: communication.RoutingInformationBase.routes:type_name -> communication.RoutingInformationBase.RoutesEntry
	60,  // 89: communication.RouteEntry.routes:type_name -> communication.Route
	61,  // 90: communication.Route.nexthops:type_name -> communication.Nexthop
	63,  // 91: communication.AnomalyAnalysis.router_anomaly:type_name -> communication.AnomalyDetection
	63,  // 92: communication.AnomalyAnalysis.external_anomaly:type_name -> communication.AnomalyDetection
	63,  // 93: communication.AnomalyAnalysis.nssa_external_anomaly:type_name -> communication.AnomalyDetection
	63,  // 94: communication.AnomalyAnalysis.lsdb_to_rib_anomaly:type_name -> communication.AnomalyDetection
	63,  // 95: communication.AnomalyAnalysis.rib_to_fib_anomaly:type_name -> communication.AnomalyDetection
	64,  // 96: communication.AnomalyDetection.superfluous_entries:type_name -> communication.Advertisement
	64,  // 97: communication.AnomalyDetection.missing_entries:type_name -> communication.Advertisement
	64,  // 98: communication.AnomalyDetection.duplicate_entries:type_name -> communication.Advertisement
	66,  // 99: communication.AccessListAnalyzer.acl_entry:type_name -> communication.ACLEntry
	70,  // 100: communication.IntraAreaLsa.areas:type_name -> communication.AreaAnalyzer
	70,  // 101: communication.InterAreaLsa.areas:type_name -> communication.AreaAnalyzer
	64,  // 102: communication.AreaAnalyzer.links:type_name -> communication.Advertisement
	74,  // 103: communication.Anomalies.overadvertised_routes:type_name -> communication.AnomalyOveradvertisedRoute
	75,  // 104: communication.Anomalies.unadvertised_routes:type_name -> communication.AnomalyUnadvertisedRoute
	76,  // 105: communication.Anomalies.duplicate_routes:type_name -> communication.AnomalyDuplicateRoute
	77,  // 106: communication.Anomalies.misconfigured_routes:type_name -> communication.AnomalyMisconfiguredRoute
	108, // 107: communication.AnomalyOveradvertisedRoute.timestamp:type_name -> google.protobuf.Timestamp
	73,  // 108: communication.AnomalyOveradvertisedRoute.router:type_name -> communication.RouterAttribute
	108, // 109: communication.AnomalyUnadvertisedRoute.timestamp:type_name -> google.protobuf.Timestamp
	73,  // 110: communication.AnomalyUnadvertisedRoute.router:type_name -> communication.RouterAttribute
	108, // 111: communication.AnomalyDuplicateRoute.timestamp:type_name -> google.protobuf.Timestamp
	73,  // 112: communication.AnomalyDuplicateRoute.router:type_name -> communication.RouterAttribute
	108, // 113: communication.AnomalyMisconfiguredRoute.timestamp:type_name -> google.protobuf.Timestamp
	73,  // 114: communication.AnomalyMisconfiguredRoute.router:type_name -> communication.RouterAttribute
	105, // 115: communication.OspfRouterInfo.router_link_states:type_name -> communication.OspfRouterInfo.RouterLinkStatesEntry
	106, // 116: communication.AreaLinkStates.router_lsas:type_name -> communication.AreaLinkStates.RouterLsasEntry
	107, // 117: communication.RouterLSA.router_links:type_name -> communication.RouterLSA.RouterLinksEntry
	4,   // 118: communication.Message.ParamsEntry.value:type_name -> communication.ResponseValue
	4,   // 119: communication.Command.ParamsEntry.value:type_name -> communication.ResponseValue
	11,  // 120: communication.StaticFRRConfiguration.RouteMapEntry.value:type_name -> communication.RouteMap
	12,  // 121: communication.StaticFRRConfiguration.AccessListEntry.value:type_name -> communication.AccessList
	23,  // 122: communication.OSPFRouterData.RouterStatesEntry.value:type_name -> communication.OSPFRouterArea
	24,  // 123: communication.OSPFRouterArea.LsaEntriesEntry.value:type_name -> communication.OSPFRouterLSA
	25,  // 124: communication.OSPFRouterLSA.RouterLinksEntry.value:type_name -> communication.OSPFRouterLSALink
	27,  // 125: communication.OSPFNetworkData.NetStatesEntry.value:type_name -> communication.NetAreaState
	28,  // 126: communication.NetAreaState.LsaEntriesEntry.value:type_name -> communication.NetworkLSA
	29,  // 127: communication.NetworkLSA.AttachedRoutersEntry.value:type_name -> communication.AttachedRouter
	27,  // 128: communication.OSPFSummaryData.NetStatesEntry.value:type_name -> communication.NetAreaState
	31,  // 129: communication.OSPFSummaryData.SummaryStatesEntry.value:type_name -> communication.SummaryAreaState
	32,  // 130: communication.SummaryAreaState.LsaEntriesEntry.value:type_name -> communication.SummaryLSA
	31,  // 131: communication.OSPFAsbrSummaryData.AsbrSummaryStatesEntry.value:type_name -> communication.SummaryAreaState
	35,  // 132: communication.OSPFExternalData.AsExternalLinkStatesEntry.value:type_name -> communication.ExternalLSA
	37,  // 133: communication.OSPFNssaExternalData.NssaExternalLinkStatesEntry.value:type_name -> communication.NssaExternalArea
	38,  // 134: communication.NssaExternalArea.DataEntry.value:type_name -> communication.NssaExternalLSA
	40,  // 135: communication.OSPFDatabase.AreasEntry.value:type_name -> communication.OSPFDatabaseArea
	37,  // 136: communication.OSPFNssaExternalAll.NssaExternalAllLinkStatesEntry.value:type_name -> communication.NssaExternalArea
	52,  // 137: communication.OSPFNeighbors.NeighborsEntry.value:type_name -> communication.NeighborList
	55,  // 138: communication.InterfaceList.InterfacesEntry.value:type_name -> communication.SingleInterface
	59,  // 139: communication.RoutingInformationBase.RoutesEntry.value:type_name -> communication.RouteEntry
	79,  // 140: communication.OspfRouterInfo.RouterLinkStatesEntry.value:type_name -> communication.AreaLinkStates
	80,  // 141: communication.AreaLinkStates.RouterLsasEntry.value:type_name -> communication.RouterLSA
	81,  // 142: communication.RouterLSA.RouterLinksEntry.value:type_name -> communication.RouterLink
...
func file_protocol_proto_init() {
	...
	file_protocol_proto_msgTypes[81].OneofWrappers = []any{}
	type x struct{}
