...
const file_protocol_proto_rawDesc = "" +
	...
	"\x11duplicate_entries\x18\a \x03(\v2\x1c.communication.AdvertisementR\x10duplicateEntries\"\xcb\x01\n" +
	"\rAdvertisement\x12*\n" +
	...
	"\aOptions\x18\x06 \x01(\tR\aOptions\"j\n" +
...
var file_protocol_proto_goTypes = []any{
	...
	(*AnomalyUnadvertisedRoute)(nil),   // 79: communication.AnomalyUnadvertisedRoute
...
var file_protocol_proto_depIdxs = []int32{
	...
	89,  // 49: communication.StaticFRRConfiguration.route_map:type_name -> communication.StaticFRRConfiguration.RouteMapEntry
	90,  // 50: communication.StaticFRRConfiguration.access_list:type_name -> communication.StaticFRRConfiguration.AccessListEntry
	...
	91,  // 59: communication.GeneralOspfInformation.areas:type_name -> communication.GeneralOspfInformation.AreasEntry
	92,  // 60: communication.OSPFRouterData.router_states:type_name -> communication.OSPFRouterData.RouterStatesEntry
	93,  // 61: communication.OSPFRouterArea.lsa_entries:type_name -> communication.OSPFRouterArea.LsaEntriesEntry
	94,  // 62: communication.OSPFRouterLSA.router_links:type_name -> communication.OSPFRouterLSA.RouterLinksEntry
	95,  // 63: communication.OSPFNetworkData.net_states:type_name -> communication.OSPFNetworkData.NetStatesEntry
	96,  // 64: communication.NetAreaState.lsa_entries:type_name -> communication.NetAreaState.LsaEntriesEntry
	97,  // 65: communication.NetworkLSA.attached_routers:type_name -> communication.NetworkLSA.AttachedRoutersEntry
	98,  // 66: communication.OSPFSummaryData.net_states:type_name -> communication.OSPFSummaryData.NetStatesEntry
	99,  // 67: communication.OSPFSummaryData.summary_states:type_name -> communication.OSPFSummaryData.SummaryStatesEntry
	100, // 68: communication.SummaryAreaState.lsa_entries:type_name -> communication.SummaryAreaState.LsaEntriesEntry
	101, // 69: communication.OSPFAsbrSummaryData.asbr_summary_states:type_name -> communication.OSPFAsbrSummaryData.AsbrSummaryStatesEntry
	102, // 70: communication.OSPFExternalData.as_external_link_states:type_name -> communication.OSPFExternalData.AsExternalLinkStatesEntry
	103, // 71: communication.OSPFNssaExternalData.nssa_external_link_states:type_name -> communication.OSPFNssaExternalData.NssaExternalLinkStatesEntry
	104, // 72: communication.NssaExternalArea.data:type_name -> communication.NssaExternalArea.DataEntry
	105, // 73: communication.OSPFDatabase.areas:type_name -> communication.OSPFDatabase.AreasEntry
	...
	106, // 87: communication.OSPFNssaExternalAll.nssa_external_all_link_states:type_name -> communication.OSPFNssaExternalAll.NssaExternalAllLinkStatesEntry
	107, // 88: communication.OSPFNeighbors.neighbors:type_name -> communication.OSPFNeighbors.NeighborsEntry
	55,  // 89: communication.NeighborList.neighbors:type_name -> communication.Neighbor
	108, // 90: communication.InterfaceList.interfaces:type_name -> communication.InterfaceList.InterfacesEntry
	...
	109, // 93: communication.RoutingInformationBase.routes:type_name -> communication.RoutingInformationBase.RoutesEntry
	...
	78,  // 109: communication.Anomalies.overadvertised_routes:type_name -> communication.AnomalyOveradvertisedRoute
	79,  // 110: communication.Anomalies.unadvertised_routes:type_name -> communication.AnomalyUnadvertisedRoute
	80,  // 111: communication.Anomalies.duplicate_routes:type_name -> communication.AnomalyDuplicateRoute
	81,  // 112: communication.Anomalies.misconfigured_routes:type_name -> communication.AnomalyMisconfiguredRoute
	113, // 113: communication.AnomalyOveradvertisedRoute.timestamp:type_name -> google.protobuf.Timestamp
	77,  // 114: communication.AnomalyOveradvertisedRoute.router:type_name -> communication.RouterAttribute
	113, // 115: communication.AnomalyUnadvertisedRoute.timestamp:type_name -> google.protobuf.Timestamp
	77,  // 116: communication.AnomalyUnadvertisedRoute.router:type_name -> communication.RouterAttribute
	113, // 117: communication.AnomalyDuplicateRoute.timestamp:type_name -> google.protobuf.Timestamp
	77,  // 118: communication.AnomalyDuplicateRoute.router:type_name -> communication.RouterAttribute
	113, // 119: communication.AnomalyMisconfiguredRoute.timestamp:type_name -> google.protobuf.Timestamp
	77,  // 120: communication.AnomalyMisconfiguredRoute.router:type_name -> communication.RouterAttribute
	110, // 121: communication.OspfRouterInfo.router_link_states:type_name -> communication.OspfRouterInfo.RouterLinkStatesEntry
	111, // 122: communication.AreaLinkStates.router_lsas:type_name -> communication.AreaLinkStates.RouterLsasEntry
	112, // 123: communication.RouterLSA.router_links:type_name -> communication.RouterLSA.RouterLinksEntry
	4,   // 124: communication.Message.ParamsEntry.value:type_name -> communication.ResponseValue
	4,   // 125: communication.Command.ParamsEntry.value:type_name -> communication.ResponseValue
	15,  // 126: communication.StaticFRRConfiguration.RouteMapEntry.value:type_name -> communication.RouteMap
	16,  // 127: communication.StaticFRRConfiguration.AccessListEntry.value:type_name -> communication.AccessList
	22,  // 128: communication.GeneralOspfInformation.AreasEntry.value:type_name -> communication.GeneralInfoOspfArea
	25,  // 129: communication.OSPFRouterData.RouterStatesEntry.value:type_name -> communication.OSPFRouterArea
	26,  // 130: communication.OSPFRouterArea.LsaEntriesEntry.value:type_name -> communication.OSPFRouterLSA
	27,  // 131: communication.OSPFRouterLSA.RouterLinksEntry.value:type_name -> communication.OSPFRouterLSALink
	29,  // 132: communication.OSPFNetworkData.NetStatesEntry.value:type_name -> communication.NetAreaState
	30,  // 133: communication.NetAreaState.LsaEntriesEntry.value:type_name -> communication.NetworkLSA
	31,  // 134: communication.NetworkLSA.AttachedRoutersEntry.value:type_name -> communication.AttachedRouter
	29,  // 135: communication.OSPFSummaryData.NetStatesEntry.value:type_name -> communication.NetAreaState
	33,  // 136: communication.OSPFSummaryData.SummaryStatesEntry.value:type_name -> communication.SummaryAreaState
	34,  // 137: communication.SummaryAreaState.LsaEntriesEntry.value:type_name -> communication.SummaryLSA
	33,  // 138: communication.OSPFAsbrSummaryData.AsbrSummaryStatesEntry.value:type_name -> communication.SummaryAreaState
	37,  // 139: communication.OSPFExternalData.AsExternalLinkStatesEntry.value:type_name -> communication.ExternalLSA
	39,  // 140: communication.OSPFNssaExternalData.NssaExternalLinkStatesEntry.value:type_name -> communication.NssaExternalArea
	40,  // 141: communication.NssaExternalArea.DataEntry.value:type_name -> communication.NssaExternalLSA
	42,  // 142: communication.OSPFDatabase.AreasEntry.value:type_name -> communication.OSPFDatabaseArea
	39,  // 143: communication.OSPFNssaExternalAll.NssaExternalAllLinkStatesEntry.value:type_name -> communication.NssaExternalArea
	54,  // 144: communication.OSPFNeighbors.NeighborsEntry.value:type_name -> communication.NeighborList
	57,  // 145: communication.InterfaceList.InterfacesEntry.value:type_name -> communication.SingleInterface
	61,  // 146: communication.RoutingInformationBase.RoutesEntry.value:type_name -> communication.RouteEntry
	83,  // 147: communication.OspfRouterInfo.RouterLinkStatesEntry.value:type_name -> communication.AreaLinkStates
	84,  // 148: communication.AreaLinkStates.RouterLsasEntry.value:type_name -> communication.RouterLSA
	85,  // 149: communication.RouterLSA.RouterLinksEntry.value:type_name -> communication.RouterLink
